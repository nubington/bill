...
namespace bill
{
    class BaseObject
    {
        ...
        public bool turnTowards(Vector2 target, Vector2 origin, float turnSpeed, GameTime gameTime)
        {
            ...
            if (crossProduct.Z > 0)
                Rotation += Util.ScaleWithGameTime(turnSpeed, gameTime);
            ...
            if (Util.AngleDifference(Rotation, targetAngle) < Util.ScaleWithGameTime(turnSpeed, gameTime))
            {
        ...
        public Object PotentialCollisionsLock = new Object();
